...
from src.chat_with.mistral.mistral_large_latest import chat_with_mistral_large_latest
...
def model_routing():
    ...
    if current_model_name == "command-a-03-2025":
        ...
        return model
    elif current_model_name == "mistral-large-latest":
        model = chat_with_mistral_large_latest(streaming=streaming, temperature=temperature)
        return model
